/*
 ...
 `AssetListTableViewController` is the main interface of this sample.  It provides
          ...
          To play an item, tap on the tableViewCell, to interact with the download APIs, long
          press on the cell and you will be provided options based on the download state associated
          with the Asset on the cell.
 */
